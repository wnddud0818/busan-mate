const env = {
  ...
  odsayApiKeyAndroid: process.env.EXPO_PUBLIC_ODSAY_API_KEY_ANDROID ?? "",
  odsayApiKeyIos: process.env.EXPO_PUBLIC_ODSAY_API_KEY_IOS ?? "",
...
export const hasOdsayApiKey = Boolean(env.odsayApiKey || env.odsayApiKeyAndroid || env.odsayApiKeyIos);
